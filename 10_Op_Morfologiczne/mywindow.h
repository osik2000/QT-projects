...
private:
    ...
    QColor bialy = QColor::fromRgb(255,255,255,255);



    // Deklaracje funkcji

    void rysuj_piksel(int x, int y, QColor color);
...
private slots:
    ...
    void on_dylatacjaButton_clicked();
    void on_erozjaButton_clicked();
    void on_otwarcieButton_clicked();
    void on_domkniecieButton_clicked();
    void on_maskSpinBox_valueChanged(int arg1);
};
