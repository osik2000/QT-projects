...
private:
    ...
    int frames = 30;
    double speed = 1.0;
    int teksturowanie_tlo = 0;
    bool isrunable = false;

    QTime end;

    QString nazwa_pliku = "", nazwa_pliku2 = "";
    ...
    QColor blend(QColor c1, QColor c2, int n);
...
private slots:
    ...
    void on_resetBottomButton_clicked();
